...
class McpClient:
    ...
    async def initialize_with_stdio(self, server_params: StdioServerParameters):
        self.client = await self.exit_stack.enter_async_context(stdio_client(server_params))
